...
class InfiniteCircularView: UIView {
    ...
    fileprivate lazy var contentCollectionView:UICollectionView = {
        let vi = UICollectionView(frame: self.frame, collectionViewLayout: InfiniteCircularLayout())
    ...
    fileprivate lazy var pageControl:UIPageControl = {
        ...
        pc.center = CGPoint(x: self.frame.size.width * 0.5, y: self.frame.size.height - 10)
